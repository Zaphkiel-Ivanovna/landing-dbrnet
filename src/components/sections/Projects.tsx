...
import { BackgroundGradient } from '../ui/background-beams';
import { Globe, Smartphone, ShoppingCart, Users, Code2, Rocket, ExternalLink, Github } from 'lucide-react';
...
const projects = [
    ...
    },
    {
        ...
        description: 'Solution SaaS de gestion pour les restaurants avec tableau de bord analytique en temps réel.',
    ...
    },
    {
        ...
        description: 'Sites web performants et optimisés SEO avec animations fluides et design responsive.',
    ...
    },
    {
        ...
        description: 'Architecture backend scalable avec authentification JWT, rate limiting et documentation Swagger.',
    ...
    {
        title: 'MVP Startup',
        description: 'Développement rapide de MVP pour startups avec itérations agiles et mise en production.',
            ...
            <div className='relative z-10 mx-auto max-w-6xl'>
                ...
                >
                    ...
                    <p className='mx-auto max-w-2xl text-[var(--color-muted)]'>
                        Une sélection de projets réalisés, des applications web aux solutions mobiles en passant par les
                        APIs.
                    </p>
                </motion.div>
                ...
                >
                    <p className='mb-6 text-[var(--color-muted)]'>Vous avez un projet en tête ? Discutons-en !</p>
                    <a
                        href='/contact'
