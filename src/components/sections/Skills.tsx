...
import { Code2, Server, Database, Smartphone, Cloud, GitBranch, Terminal, Palette } from 'lucide-react';
            ...
            <div className='mx-auto max-w-6xl'>
                ...
                >
                    ...
                    <p className='mx-auto max-w-2xl text-[var(--color-muted)]'>
                        Un ensemble de technologies modernes maîtrisées pour créer des applications performantes et
                        scalables.
                    </p>
                </motion.div>
                    ...
                    <div className='flex gap-8 animate-scroll'>
                        {[...techLogos, ...techLogos].map((tech, index) => (
                            ...
                            >
                                ...
                                <span className='text-sm font-medium text-[var(--color-foreground)]'>{tech.name}</span>
                            </div>
                        ))}
                    </div>
                </motion.div>
